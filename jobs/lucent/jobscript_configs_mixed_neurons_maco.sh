...
srun python3 /scratch/vihps/vihps01/vit-interpretability-thesis/code/jobs/lucent/generate_configs_mixed_neurons_maco.py --output-dir /scratch/vihps/vihps01/vit-interpretability-thesis/configs-mixed-neurons-maco